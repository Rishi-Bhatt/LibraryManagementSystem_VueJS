    ...
    <body class="d-flex align-items-center py-4 bg-body-tertiary">
        ...
        <main class="form-signin w-100 m-auto">
            <form @submit.prevent="submitForm">
                ...
                <h1 class="h3 mb-0 fw-normal"> Add Details of New Book </h1>
                <br>
                ...
                <div class="form-group">
                    <label for="DownloadPrice">Price</label>
                    <input type="text" name="DownloadPrice" v-model="this.DownloadPrice" class="form-control" id="DownloadPrice" aria-describedby="names" placeholder="Enter updated price">

                </div>
                <hr>
                <div class="form-group mt-3">
                    <label class="mr-6">Upload Book:</label>
                    <input type="file" @change="handleFileUpload" name="book_content">
                </div>
...
export default {
    ...
    methods: {
        async submitForm() {
            ...
            try {
                const response = await axios.put(`http://localhost:5000/api/ebooks/${this.book_id}`, formData, {
                    headers: {
